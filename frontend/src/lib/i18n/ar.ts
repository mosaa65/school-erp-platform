...
export const PERMISSION_RESOURCE_LABELS: Record<string, string> = {
  ...
  "homework-templates": "قوالب الواجبات",
  "homework-dashboard": "لوحة تحكم الواجبات",
  "homework-studio": "استوديو الواجبات",
  "homework-calendar": "تقويم الواجبات",
  "homework-submissions": "التسليمات والتصحيح",
  "homework-supervision": "إشراف الواجبات",
  "homework-reports": "تقارير الواجبات",
  "homework-settings": "إعدادات الواجبات",
  "homework-rubrics": "معايير التصحيح",
  homeworks: "الواجبات",
  "homework-entry": "إدخال الواجب السريع",
  "student-homeworks": "واجبات الطلاب",
  "student-homework-profile": "ملف واجبات الطالب",
  "annual-statuses": "الحالات السنوية",
  "promotion-decisions": "قرارات الترفيع",
  "grading-outcome-rules": "قواعد النتائج",
  "assessment-periods": "الفترات المرنة",
  "assessment-period-components": "مكونات الفترات",
  "assessment-component-source-periods": "مصادر محصلة الفترات",
  "student-period-results": "نتائج الفترات",
