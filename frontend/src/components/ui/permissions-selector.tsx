...
const RESOURCE_CATEGORIES: Record<string, string> = {
  ...
  "employee-departments": "hr",
  "employee-documents": "hr",
  "employee-leave-balances": "hr",
  "employee-leaves": "hr",
  "employee-lifecycle-checklists": "hr",
  "employee-courses": "hr",
  ...
  "assessment-periods": "academics",
  "assessment-period-components": "academics",
  "assessment-component-source-periods": "academics",
  "student-period-results": "academics",
  "student-period-component-scores": "academics",
