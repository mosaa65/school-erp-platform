...
export const APP_NAV_GROUPS: AppNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      {
        href: "/app/homework-dashboard",
        label: "لوحة تحكم الواجبات",
        icon: BarChart3,
      ...
      {
        href: "/app/homework-reports",
        label: "تقارير الواجبات",
        icon: FileText,
        requiredPermission: "homework-reports.read",
      },
      {
        href: "/app/homework-settings",
        label: "قوالب وإعدادات الواجبات",
        icon: Settings2,
      ...
      },
      {
        ...
        label: "إدخال الواجب السريع",
        icon: ClipboardCheck,
        requiredPermission: "student-homeworks.bulk-update",
      },
      {
      ...
      {
        href: "/app/student-homework-profile",
        label: "ملف واجبات الطالب",
        icon: UserRound,
        requiredPermission: "student-homeworks.read",
      },
    ],
