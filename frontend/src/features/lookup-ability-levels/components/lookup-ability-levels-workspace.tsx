...
export function LookupAbilityLevelsWorkspace() {
  ...
  return (
    <PageShell title="مستويات القدرة">
      ...
      >
        {!canCreate && !isEditing ? (
          ...
          <form className="space-y-4" onSubmit={handleSubmitForm} data-testid="ability-level-form">
            ...
            <div className="flex gap-2 pt-2">
              ...
              >
                ...
                {isEditing ? "حفظ التعديلات" : "إسناد مستوى القدرة"}
              </Button>
              {isEditing ? (
