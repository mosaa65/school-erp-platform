      ...
      <Card className="h-fit border-border/70 bg-card/80">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            {isEditing ? "تعديل قرار ترفيع" : "إنشاء قرار ترفيع"}
          </CardTitle>
          <CardDescription>إدارة قرارات النتيجة السنوية والترفيع.</CardDescription>
        </CardHeader>
        <CardContent>
          {!canCreate && !isEditing ? (
            ...
            >
              ...
              <div className="flex gap-2">
                <Button type="submit" className="flex-1 gap-2" disabled={isSubmitting}>
                  ...
                  {isEditing ? "حفظ التعديلات" : "إنشاء قرار ترفيع"}
                </Button>
                {isEditing ? (
      ...
      <Card className="border-border/70 bg-card/80">
        <CardHeader className="space-y-3">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <CardTitle>قرارات الترفيع</CardTitle>
              ...
              <div className="flex flex-wrap items-start justify-between gap-2">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    النتائج السنوية: {item._count.annualResults} | قواعد الانتقال المشروط:{" "}
                    {item._count.conditionalForRules} | قواعد الإبقاء: {item._count.retainedForRules}
                  </p>
                </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 border-t border-border/70 pt-3">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                disabled={
                  !pagination || pagination.page <= 1 || promotionDecisionsQuery.isFetching
                }
              >
                السابق
              </Button>
