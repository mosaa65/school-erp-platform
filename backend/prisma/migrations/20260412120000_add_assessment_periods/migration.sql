-- Add flexible assessment periods and component scoring foundation.
...
ALTER TABLE `assessment_periods`
  ADD CONSTRAINT `assessment_periods_academic_year_id_fkey`
    FOREIGN KEY (`academic_year_id`) REFERENCES `academic_years`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `assessment_periods_academic_term_id_fkey`
    FOREIGN KEY (`academic_term_id`) REFERENCES `academic_terms`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `assessment_periods_academic_month_id_fkey`
    FOREIGN KEY (`academic_month_id`) REFERENCES `academic_months`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `assessment_periods_locked_by_user_id_fkey`
    FOREIGN KEY (`locked_by_user_id`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `assessment_periods_created_by_fkey`
    FOREIGN KEY (`created_by`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `assessment_periods_updated_by_fkey`
    FOREIGN KEY (`updated_by`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE `assessment_period_components`
  ADD CONSTRAINT `assessment_period_components_assessment_period_id_fkey`
    FOREIGN KEY (`assessment_period_id`) REFERENCES `assessment_periods`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `assessment_period_components_created_by_fkey`
    FOREIGN KEY (`created_by`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `assessment_period_components_updated_by_fkey`
    FOREIGN KEY (`updated_by`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE `assessment_component_source_periods`
  ADD CONSTRAINT `assessment_component_source_periods_component_id_fkey`
    FOREIGN KEY (`assessment_period_component_id`) REFERENCES `assessment_period_components`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `assessment_component_source_periods_source_id_fkey`
    FOREIGN KEY (`source_period_id`) REFERENCES `assessment_periods`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `assessment_component_source_periods_created_by_fkey`
    FOREIGN KEY (`created_by`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `assessment_component_source_periods_updated_by_fkey`
    FOREIGN KEY (`updated_by`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE `student_period_results`
  ADD CONSTRAINT `student_period_results_assessment_period_id_fkey`
    FOREIGN KEY (`assessment_period_id`) REFERENCES `assessment_periods`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_results_student_enrollment_id_fkey`
    FOREIGN KEY (`student_enrollment_id`) REFERENCES `student_enrollments`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_results_subject_id_fkey`
    FOREIGN KEY (`subject_id`) REFERENCES `subjects`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_results_academic_year_id_fkey`
    FOREIGN KEY (`academic_year_id`) REFERENCES `academic_years`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_results_academic_term_id_fkey`
    FOREIGN KEY (`academic_term_id`) REFERENCES `academic_terms`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_results_academic_month_id_fkey`
    FOREIGN KEY (`academic_month_id`) REFERENCES `academic_months`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_results_term_subject_offering_id_fkey`
    FOREIGN KEY (`term_subject_offering_id`) REFERENCES `term_subject_offerings`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_results_section_id_fkey`
    FOREIGN KEY (`section_id`) REFERENCES `sections`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_results_locked_by_user_id_fkey`
    FOREIGN KEY (`locked_by_user_id`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_results_created_by_fkey`
    FOREIGN KEY (`created_by`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_results_updated_by_fkey`
    FOREIGN KEY (`updated_by`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE `student_period_component_scores`
  ADD CONSTRAINT `student_period_component_scores_result_id_fkey`
    FOREIGN KEY (`student_period_result_id`) REFERENCES `student_period_results`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_component_scores_component_id_fkey`
    FOREIGN KEY (`assessment_period_component_id`) REFERENCES `assessment_period_components`(`id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_component_scores_created_by_fkey`
    FOREIGN KEY (`created_by`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `student_period_component_scores_updated_by_fkey`
    FOREIGN KEY (`updated_by`) REFERENCES `users`(`id`)
    ON DELETE SET NULL ON UPDATE CASCADE;
