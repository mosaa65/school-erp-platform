...
export async function seedSystem01Settings(prisma: PrismaClient) {
  ...
  const systemSettings = [
    ...
    {
      settingKey: 'employee_single_session_mode',
      settingValue: 'false',
      settingType: SystemSettingType.BOOLEAN,
      category: 'security',
      description: 'عند التفعيل، أي تسجيل دخول جديد للموظف يلغي الجلسات السابقة بعد الموافقة.',
    },
    {
      settingKey: 'employee_new_device_requires_approval',
      settingValue: 'false',
      settingType: SystemSettingType.BOOLEAN,
      category: 'security',
      description: 'هل يتطلب دخول الموظف من جهاز جديد موافقة إدارية.',
    },
    {
      settingKey: 'guardian_multi_device_allowed',
      settingValue: 'true',
      settingType: SystemSettingType.BOOLEAN,
      category: 'security',
      description: 'السماح لولي الأمر بتعدد الأجهزة بعد التفعيل الأول.',
    },
    {
      settingKey: 'first_activation_requires_admin_approval_for_employee',
      settingValue: 'true',
      settingType: SystemSettingType.BOOLEAN,
      category: 'security',
      description: 'هل يحتاج الموظف لموافقة إدارية عند تعيين كلمة المرور لأول مرة.',
    },
    {
      settingKey: 'first_activation_requires_admin_approval_for_guardian',
      settingValue: 'false',
      settingType: SystemSettingType.BOOLEAN,
      category: 'security',
      description: 'هل يحتاج ولي الأمر لموافقة إدارية عند تعيين كلمة المرور لأول مرة.',
    },
    {
